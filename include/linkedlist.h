 ...
 * Created by Stanford CS144 Staff https://suclass.stanford.edu/courses/course-v1:Engineering+CS144+Fall2017/info 
 *
 *****************************************************************************/
...
/**
  * Create a clone with the same objects found in the given linkedlist and returns its pointer
  * If you need to clone the objects as well pass a function that will be invoked on each object 
  * seperately. The function is expected to take void* as an argument and return void*. The actual
  * implementation is left to the user. Otherwise, if you just need to clone the list, pass NULL to
  * the function
  */ 
linked_list_t *ll_clone(linked_list_t* ll, void* (* clone_object)(void*));
